generazione_input_test_3_qubit;
% generazione_H_test_3_qubit;
% generazione_X_test_3_qubit;
% generazione_CX_test_3_qubit;

%%

time_ = load('../output/out.t.txt');
A = load('../output/out.rho.txt');
