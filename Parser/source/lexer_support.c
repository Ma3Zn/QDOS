...
#include "../include/lexer_support.h"
...
/*
 *  Funzione invocata dal lexer per la gestione dell'input da file separati.
 *  Al momento non prevediamo quetsa possibilità e vincoliamo làinput ad un
 *  solo file
 */
int yywrap(void)
{
